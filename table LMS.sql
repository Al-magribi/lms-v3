...
CREATE TABLE l_attitude(
    ...
    CONSTRAINT l_attitude_month_check CHECK (((month)::text = ANY ((ARRAY['Januari'::character varying, 'Februari'::character varying, 'Maret'::character varying, 'April'::character varying, 'Mei'::character varying, 'Juni'::character varying, 'Juli'::character varying, 'Agustus'::character varying, 'September'::character varying, 'Oktober'::character varying, 'November'::character varying, 'Desember'::character varying])::text[]))),
