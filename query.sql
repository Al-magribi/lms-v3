...
CREATE UNIQUE INDEX idx_attitude_unique ON l_attitude(student_id, subject_id, class_id, chapter_id, month, semester);
CREATE UNIQUE INDEX idx_formative_unique ON l_formative(student_id, subject_id, class_id, chapter_id, month, semester);
CREATE UNIQUE INDEX idx_summative_unique ON l_summative(student_id, subject_id, class_id, chapter_id, month, semester);

-- If the above constraints already exist, drop them first and recreate:
DROP INDEX IF EXISTS idx_attitude_unique;
DROP INDEX IF EXISTS idx_formative_unique;
DROP INDEX IF EXISTS idx_summative_unique;
CREATE UNIQUE INDEX idx_attitude_unique ON l_attitude(student_id, subject_id, class_id, chapter_id, month, semester);
CREATE UNIQUE INDEX idx_formative_unique ON l_formative(student_id, subject_id, class_id, chapter_id, month, semester);
CREATE UNIQUE INDEX idx_summative_unique ON l_summative(student_id, subject_id, class_id, chapter_id, month, semester);

-- FIX FOR EXISTING DATABASE - Run these commands to fix constraint issues:
DROP INDEX IF EXISTS idx_attitude_unique;
DROP INDEX IF EXISTS idx_formative_unique;
DROP INDEX IF EXISTS idx_summative_unique;
CREATE UNIQUE INDEX idx_attitude_unique ON l_attitude(student_id, subject_id, class_id, chapter_id, month, semester);
...
-- COMPLETE FIX SCRIPT - Run this to fix the database:
...
-- Step 2: Create new constraints with semester included
CREATE UNIQUE INDEX idx_attitude_unique ON l_attitude(student_id, subject_id, class_id, chapter_id, month, semester);
CREATE UNIQUE INDEX idx_formative_unique ON l_formative(student_id, subject_id, class_id, chapter_id, month, semester);
CREATE UNIQUE INDEX idx_summative_unique ON l_summative(student_id, subject_id, class_id, chapter_id, month, semester);

-- Step 3: Verify constraints
SELECT indexname, indexdef FROM pg_indexes WHERE tablename = 'l_attitude' AND indexname LIKE '%unique%';
SELECT indexname, indexdef FROM pg_indexes WHERE tablename = 'l_formative' AND indexname LIKE '%unique%';
SELECT indexname, indexdef FROM pg_indexes WHERE tablename = 'l_summative' AND indexname LIKE '%unique%';
